 ...
 */
<<<<<<< HEAD:GenConnection-MVC/src/main/java/controller/NotificacaoServlet.java
@WebServlet(urlPatterns = { "/notificacao", "/cadastrar-notificacao", "/editar-notificacao", "/atualizar-notificacao",
		"/deletar-notificacao" })
=======
@WebServlet(urlPatterns = { "/notificacao", "/cadastrar-notificacao", "/editar-notificacao", "/atualizar-notificacao", "/deletar-notificacao" })
>>>>>>> main:GenConnectionMVC/src/main/java/controller/NotificacaoServlet.java
