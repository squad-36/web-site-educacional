...
<<<<<<< HEAD:GenConnection-MVC/src/main/webapp/view/usuario/index.jsp
	<% @SuppressWarnings("unchecked") List<Usuario> lista = (List<Usuario>) request.getAttribute("usuario");
=======
<%
  ...
  <ul class="nav justify-content-center">
	...
	<table class="table container">
		...
		<tbody>
			...
			<%
			for (Usuario a : lista) {
>>>>>>> main:GenConnectionMVC/src/main/webapp/view/usuario/index.jsp
			%>
...
>>>>>>> main:GenConnectionMVC/src/main/webapp/view/usuario/index.jsp
			...
			<body>
				...
				<!-- Menu -->
				<ul class="nav justify-content-center">
					<li class="nav-item"><a class="nav-link active text-dark fs-4" aria-current="page"
							href="./index.html">Home</a></li>
					<li class="nav-item"><a class="nav-link active text-dark fs-4"
							href="../permissoes/index.jsp">Permissões</a></li>
					<li class="nav-item"><a class="nav-link text-dark fs-4" href="./usuario">Usuarios</a></li>
					<li class="nav-item"><a class="nav-link text-dark fs-4"
							href="../atividades/index.jsp">Atividades</a></li>
					<li class="nav-item"><a class="nav-link text-dark fs-4" href="../jogos/index.jsp">Jogos</a></li>
					<li class="nav-item"><a class="nav-link text-dark fs-4"
					...
					<tbody>
						...
						<% for (Usuario a : lista) { %>
							<tr>
								...
								<td>
									<a class="btn btn-success" href="editar-usuario?id=<%=a.getId_usuario()%>">Atualizar
										Usuario</a>
									<a class="btn btn-danger" href="deletar-usuario?id=<%=a.getId_usuario()%>">Deletar
										Usuario</a>
								</td>
