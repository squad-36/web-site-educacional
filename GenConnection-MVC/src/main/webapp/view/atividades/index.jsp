<%@ page language="java" contentType="text/html; charset=UTF-8" pageEncoding="UTF-8" import="model.Atividades"
	import="java.util.List" %>

	<% @SuppressWarnings("unchecked") List<Atividades> lista = (List<Atividades>) request.getAttribute("Atividades");
			%>
