<%@ page language="java" contentType="text/html; charset=UTF-8" pageEncoding="UTF-8" import="model.Permissao"
	import="java.util.List" %>

	<% @SuppressWarnings("unchecked") List<Permissao> lista = (List<Permissao>) request.getAttribute("permissao");
			%>
			...
			<body>
				...
				<ul class="nav justify-content-center">
					...
					<li class="nav-item"><a class="nav-link active text-dark fs-4" href="./index.jsp">Permissões</a>
					</li>
					<li class="nav-item"><a class="nav-link text-dark fs-4" href="../usuario/index.jsp">Usuarios</a>
					</li>
